    ...
    function addElement(dom){
        ...
        path1
          ...
          .attr('d', function(d,i){  
            ...
            var y1 = 0 - cfg.radius
            var x2 = 0
            var y2 = 0 - cfg.radius - cfg.min  - cfg.max
            var coorPoint =  'M'+x1+' '+y1+' '+x1+' '+y2+' '+(x1+12)+' '+y2+' '+(x1+12)+'  '+y1+' '
        ...
        path2
          ...
          .attr('d', function(d,i){
            ...
            var y1 = 0 - cfg.radius
            var x2 = 0
            var y2 = 0 - cfg.radius - cfg.min - linear(d.data.value )
            var coorPoint =  'M'+x1+' '+y1+' '+x1+' '+y2+' '+(x1+12)+' '+y2+' '+(x1+12)+'  '+y1+' '
             return coorPoint
          })
          .attr('transform', 'rotate(0)')
        ...
        text
         .text(function( d ){
          ...
          .attr('y',function(d,i){
            return 0 - cfg.radius+textStyle.distance
          })
